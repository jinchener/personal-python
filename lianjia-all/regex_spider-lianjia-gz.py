...
class regexSpider:
    ...
    def analysis(self , page):
        ...
        for i in list:
            ...
            rent = i.find("div", "col-1").find("a").get_text().encode('utf-8').replace("套正在出租", "").strip()
            ...
            year = lal.find("span").next_sibling.encode('utf-8').replace("建造", "").strip()
...
if __name__ == "__main__":
    ...
    urllist="http://gz.lianjia.com/xiaoqu/"
