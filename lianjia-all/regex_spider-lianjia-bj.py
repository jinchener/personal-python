...
class regexSpider:
    ...
    def analysis(self , page):
        ...
        for i in list:
            ...
            saler  = i.find("div", "col-1").find_all("a")[0].get_text().encode('utf-8').replace("30天成交", "").split("套", 1)[0].replace(" ","").strip()
            ...
            total = name + "|" +saler+"|"+ rent + "|" + locate1 + "|" + locate2 + "|"+build+"|" + price + "|" + sale + "|" + year + "|" + school + "|" + subline.strip() + "|" + subst + "\n"
    ...
    def spiderWorking(self , startUrlList , downUrlRegex , writeUrlRegex , ignoreUrlRegex , writeFileName , deepMax):
        ...
        file_object_Z.write("小区名|30天成交|出租数|所属区|区域|建筑方式|均价|在售数|年份|学区|地铁线|地铁站")
        file_object_Z.write("\n")
...
if __name__ == "__main__":
    ...
    startUrlList = [ "http://bj.lianjia.com/xiaoqu/" ]
    # ["http://pinyin.sogou.com/dict/"]
    downUrlRegex = r"(http://bj.lianjia.com/xiaoqu/([a-z]{2,20}))|(http://bj.lianjia.com/xiaoqu/([a-z]{2,20})/pg[0-9]{1,2})"
    ...
    writeUrlRegex = r"(http://bj.lianjia.com/xiaoqu/([a-z]{2,20})/pg[0-9]{0,4})"
